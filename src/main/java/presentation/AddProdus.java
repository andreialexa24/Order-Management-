...
public class AddProdus extends JFrame {
...
//    }
    ...
    public AddProdus(JTable tabel) {
        ...
        /**
         * Punem butonul de AddProdus in functiune, care ne va adauga produsul,
         * pentru care am completat campurile, in tabel
         */
        ...
        add.addActionListener(n->{
                    Produs p1 = new Produs(nume.getText(), Integer.parseInt(stoc.getText()), Float.parseFloat(pret.getText()));
